            ...
            <div class="main-sidebar">
                <aside id="sidebar-wrapper">
                    ...
                    <ul class="sidebar-menu">
                        ...
                        <li class="nav-item dropdown">
                            <a class="nav_link {{ Request::is('dashboard-admin/data-orderan') ? 'active' : '' }}"
                                href="dashboard-admin/data-orderan"><i class="bi bi-cart"></i><span
                                    class="nav_name">Orderan</span> </a>
                        </li>

                        <li class="nav-item dropdown">
                            <a class="nav_link {{ Request::is('/dashboard-admin/data-user') ? 'active' : '' }}"
                                href="/dashboard-admin/data-user"> <i class="bi bi-people"></i><span
                                    class=" nav_name">Users</span> </a>
                        </li>

                        <li class="nav-item dropdown">
                            <a class="nav_link {{ Request::is('/dashboard-admin/data-menu') ? 'active' : '' }}"
                                href="/dashboard-admin/data-menu"><i class="bi bi-menu-up"></i><span
                                    class="nav_name">Menu</span> </a>
                        </li>
